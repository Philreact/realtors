  ...
  return (
    <div className="realtors">
      ...
      <div className="realtors__list">
        <img src={Realtor1} alt="" className="realtors__img" />
        <div className="realtors__details">
          <h4 className="heading-4 heading-4--light">Erick Feinman</h4>
          <p className="realtors__sold">245 houses sold</p>
        </div>
        <img src={Realtor2} alt="" className="realtors__img" />
        <div className="realtors__details">
          <h4 className="heading-4 heading-4--light">Kim Brown</h4>
          <p className="realtors__sold">212 houses sold</p>
        </div>
        <img src={Realtor3} alt="" className="realtors__img" />
        <div className="realtors__details">
